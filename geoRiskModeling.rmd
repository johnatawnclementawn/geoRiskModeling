...
```{r graffitiAggregate, echo=TRUE, message=FALSE, warning=FALSE}
...
allPredictors <- rbind( Illegal_Dumping, liquourLicenses, metroStops, streetlightsOut, thefts)
```
...
```{r nnFig, echo=TRUE, message=FALSE, warning=FALSE}
...
```{r correlationSM, fig.height=10, fig.width= 6, echo=TRUE, message=FALSE, warning=FALSE}
correlation.long <-
...
```{r crime2018, echo=TRUE, message=FALSE, warning=FALSE}
